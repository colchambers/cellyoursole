...
class TennisServeModal extends Modal{
	// Item Details
	var items : Dictionary.<int, TennisScenarioItem>;
	var defaultItemId: int = 1;
	
	function TennisServeModal(){
		super();
		setListName("tennis_serves");
		setCurrentMaxIdName("tennis_serves_current_index");
		persistentDataPath = '/mnt/extSdCard/cell/court/serves';
